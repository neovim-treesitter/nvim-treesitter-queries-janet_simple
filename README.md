...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-janet_simple/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-janet_simple/actions/workflows/validate.yml)

Neovim tree-sitter queries for **janet_simple**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-janet_simple",
...
- [ ] Changes are scoped to `janet_simple` — do not include files for other languages
